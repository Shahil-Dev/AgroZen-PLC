          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <p className="text-slate-500 text-lg md:text-xl leading-relaxed max-w-xl font-medium">
                Pioneering the integration of IoT and precision biotechnology to
                redefine sustainable food security. Our systems optimize yield
            ...
            >
              {[
                {
                  title: "Precision IoT Monitoring",
                  desc: "Real-time soil & climate analytics.",
                },
                {
                  title: "Hydroponic Architecture",
                  desc: "Vertical farming with 90% less water.",
                },
                {
                  title: "Bio-Genomic Research",
                  desc: "Enhanced seed resilience & nutrition.",
                },
                {
                  title: "Automated Harvesting",
                  desc: "AI-driven robotic crop management.",
                },
              ].map((feature, i) => (
                <div
                  key={i}
                  className="group flex flex-col gap-2 p-4 rounded-2xl hover:bg-slate-50 transition-colors duration-300"
                >
                  ...
                  <p className="text-slate-400 text-sm pl-7 leading-snug">
                    {feature.desc}
                  </p>
                </div>
              ))}
          ...
          >
            ...
            <div className="relative w-full aspect-square max-w-[500px]">
                ...
                {[
                  {
                    Icon: Microscope,
                    label: "R&D Labs",
                    pos: "justify-end items-end",
                  },
                  {
                    Icon: CloudSun,
                    label: "Climate",
                    pos: "justify-start items-end",
                  },
                  {
                    Icon: Waves,
                    label: "Irrigation",
                    pos: "justify-end items-start",
                  },
                  {
                    Icon: ShieldCheck,
                    label: "Security",
                    pos: "justify-start items-start",
                  },
                ].map((node, i) => (
                  <motion.div
                    key={i}
              ...
              >
                ...
                <h4 className="font-bold text-sm uppercase tracking-widest text-emerald-400">
                  Yield Optima
                </h4>

            ...
            <div className="relative w-full aspect-[4/5] max-w-[480px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-700 to-indigo-950 rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(30,58,138,0.25)] overflow-hidden">
                ...
                <div className="absolute inset-0 p-10 md:p-14 flex flex-col justify-between text-white">
                  <div className="space-y-4">
                    ...
                    <h4 className="text-3xl font-bold tracking-tight mt-6 leading-tight">Elite <br/>Eco-Reserves</h4>
                  </div>
                  
                  <div className="space-y-8">
                    <div className="flex items-center gap-6">
                      <div className="flex-1 h-[1px] bg-white/20" />
                      <span className="text-[10px] uppercase tracking-[0.5em] font-black text-blue-300 whitespace-nowrap">Est. 2026</span>
                    </div>
                    <p className="text-sm md:text-base text-blue-100/80 leading-relaxed font-medium">
                      Curating high-end sustainable retreats where traditional agriculture meets five-star hospitality.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <div className="pr-4">
                    <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest">Destination</p>
                    <p className="text-slate-900 font-extrabold text-lg">Azure Reserve</p>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <p className="text-slate-500 text-lg md:text-xl leading-relaxed max-w-lg font-medium italic">
                "Where nature whispers and luxury speaks." Our retreats offer an immersive escape into the heart of agricultural heritage.
              </p>
            </motion.div>

            {/* Feature Highlights Grid with better Alignment */}
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-12">
              {[
                { icon: Palmtree, title: "Lush Lodges", desc: "Eco-friendly architectural marvels." },
                { icon: Globe2, title: "Heritage Hubs", desc: "Discover ancient farming wisdom." },
                { icon: Umbrella, title: "Wellness", desc: "Holistic sanctuary for the soul." },
                ...
                <div key={i} className="group flex items-start gap-5">
                  ...
                  <div className="space-y-2 mt-1">
                    <h5 className="font-bold text-slate-900 text-lg leading-none tracking-tight">{item.title}</h5>
            ...
            <motion.div variants={itemVariants} className="pt-4">
              ...
              >
                <span className="relative z-10 tracking-widest text-lg uppercase">Book Stay</span>
